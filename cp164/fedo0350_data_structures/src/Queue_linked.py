...
class Queue:
    ...
    def insert(self, value):
        ...
        -------------------------------------------------------
        """
        int_node = _Queue_Node(value, None)
    ...
    def is_identical(self, target):
        ...
        while identical and self1 is not None:
            if self1._value != target1._value:
                identical = False
            self1 = self1._next
            target1 = target1._next
