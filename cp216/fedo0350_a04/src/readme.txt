...
Q2.2 STATS type                           [1/1/*]
Q2.3 letter_grade()                       [2/2/*]
Q2.4 import_data()                        [5/5/*]
Q2.5 report_data(),mean,stddev,median,etc [6/6/*]
...
a[]:3,1,4,5,2,7,6,9,8
is_sorted(a):0
selection sort:1,2,3,4,5,6,7,9,8
is_sorted(b):1
quick sort:1,2,3,4,5,6,7,8,9
is_sorted(b):1
Algorithm runtime testing:
time_span(selection_sort(10000 numbers) for 10 times)(ms):0.0
time_span(quick_sort(10000 numbers) for 1000 times)(ms):3765.0
time_span(selection_sort(10000 numbers))/time_span(quick_sort(10000 numbers)):0.0
